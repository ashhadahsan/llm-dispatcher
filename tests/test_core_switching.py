...
class TestLLMSwitch:
    ...
    def setup_method(self):
        ...
        self.openai_provider = MockProvider(
            "openai",
            {
                "gpt-4": ModelInfo(
                    name="gpt-4",
        ...
        self.anthropic_provider = MockProvider(
            "anthropic",
            {
    ...
    async def test_select_llm_basic(self):
        ...
        request = TaskRequest(
            prompt="Write a story about a robot", task_type=TaskType.TEXT_GENERATION
        )
    ...
    async def test_select_llm_with_constraints(self):
        ...
        constraints = {"max_cost": 0.01, "max_latency": 2000}
    ...
    async def test_task_specific_routing(self):
        ...
        reasoning_request = TaskRequest(
            prompt="Solve this complex logic problem", task_type=TaskType.REASONING
        )
    ...
    async def test_optimization_strategies(self):
        ...
        request = TaskRequest(
            prompt="Generate text", task_type=TaskType.TEXT_GENERATION
        )
        ...
        perf_config.switching_rules.optimization_strategy = (
    ...
    async def test_fallback_on_failure(self):
        ...
        with patch.object(
            ...
            self.anthropic_provider, "generate"
        ) as mock_anthropic:
    ...
    def test_update_config(self):
        ...
        assert (
            self.switch.config.switching_rules.optimization_strategy
    ...
    def test_decision_weights(self):
        ...
        # Set custom weights
        custom_weights = {"performance": 0.6, "cost": 0.3, "latency": 0.1}
...
class TestPerformanceScoring:
    ...
    def setup_method(self):
        ...
        self.provider.performance_metrics["test-model"] = PerformanceMetrics(
            mmlu_score=0.8, human_eval_score=0.7, latency_ms=1000, cost_efficiency=0.85
        )

    def test_get_performance_score(self):
        """Test performance score calculation."""
        score = self.provider.get_performance_score(
            "test-model", TaskType.TEXT_GENERATION
        )
        assert 0 <= score <= 1
        assert score > 0
    ...
    def test_estimate_tokens(self):
        ...
        tokens = self.provider.estimate_tokens(
